...
class ResearchContentTests(TestCase):
    ...
    def test_previous_two_step_installation_gets_optional_fields_and_search_notice(self):
        ...
        self.assertIn('identificadores disponibles sirven para buscar referencias',how.body)
        self.assertIn('puedes escribirla sin una foto de la placa; es opcional',how.body)
        self.assertIn('referencias generales del tipo de equipo no identifican la unidad',how.body)
