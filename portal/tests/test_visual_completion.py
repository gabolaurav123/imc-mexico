...
class VisualCompletionTests(TestCase):
    ...
    def test_manually_declared_serial_without_plate_photo_wins_over_ocr(self):
        ...
        self.assertEqual(self.machine.provenance["serial"]["source"], "user")
        self.assertEqual(self.machine.provenance["serial"]["review"], "confirmed")
        self.assertTrue(self.machine.provenance["serial"]["source_date"])
