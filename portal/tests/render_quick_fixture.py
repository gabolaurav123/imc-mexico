...
context={'csrf_token':'a'*64,'machine':machine,'data':machine.data,'provenance':{},'machine_json':state,'assets':assets,'categories':[],'categories_json':[],'catalog_models_json':[],'catalog_brands':[],'step':1,'user':user,'request':SimpleNamespace(path=f'/panel/maquinarias/{machine.id}/'),'analytics_settings':{'enabled':False}}
