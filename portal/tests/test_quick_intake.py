...
class QuickIntakeContentSeedTests(TestCase):
    ...
    def test_seed_upgrades_untouched_live_text_idempotently_and_renders_two_steps(self):
        ...
        self.assertIn('ficha compartible',content.title)
        self.assertIn('01 · Elige el tipo de máquina y aporta serie o fotos',content.body)
        self.assertIn('02 · Edita, comparte o envía tu ficha',content.body)
        ...
        self.assertContains(response,'01 · Elige el tipo de máquina y aporta serie o fotos')
        self.assertContains(response,'02 · Edita, comparte o envía tu ficha')
        content.delete()
        self.seed()
