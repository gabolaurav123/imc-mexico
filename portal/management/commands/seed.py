...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        previous_prepared_share_defaults = {
        ...
        pages = {**previous_prepared_share_defaults,
            'como-funciona': ('De tu máquina a una ficha compartible', '01 · Elige el tipo de máquina y aporta serie o fotos\nCompleta tus datos de contacto y selecciona el tipo de máquina en el buscador. Te preguntamos si tienes el número de serie: puedes escribirla sin una foto de la placa; es opcional si aportas fotografías. Sin serie, puedes continuar sólo con fotos. Necesitamos al menos serie o imágenes para comenzar. Pulsa «Generar ficha de maquinaria»: las fotos y los identificadores disponibles sirven para buscar referencias y preparar la descripción, las características y, cuando haya evidencia suficiente, un rango de año y valor orientativo. Las referencias generales del tipo de equipo no identifican la unidad ni confirman sus especificaciones.\n\n02 · Edita, comparte o envía tu ficha a IMC México\nLa ficha queda preparada sin pedirte que llenes más campos técnicos. Puedes corregirla, indicar un año o precio exacto y añadir horas y ubicación. Los datos sin valor no aparecen en la ficha compartida. Comparte la ficha web mediante un enlace corto que puedes desactivar; no necesitas que aparezca antes en el catálogo. La serie y el contacto se muestran sólo si lo autorizas expresamente al compartir. También puedes enviar la ficha a revisión: IMC México autoriza por separado su publicación en el catálogo.'),
            'preguntas-frecuentes': ('Preguntas frecuentes', '¿Qué necesito para empezar? Elige el tipo de máquina y aporta su número de serie o fotografías. La foto de la placa es opcional. Puedes empezar sin conocer el año, precio u horas.\n\n¿La ficha se completa automáticamente? El sistema identifica información, consulta referencias y propone una ficha editable. Puede sugerir rangos de año y precio cuando haya evidencia suficiente. No certifica el funcionamiento ni inventa especificaciones exactas. Puedes sustituir las propuestas por datos que conozcas.\n\n¿Puedo compartir antes de la aprobación? Sí. Como propietario de una ficha preparada, puedes habilitar un enlace corto para compartirla por WhatsApp, Facebook u otras aplicaciones, y desactivarlo después. Compartir no equivale a publicar en el catálogo de IMC México.\n\n¿Qué se ve en el enlace? Los datos completados y las fotografías de maquinaria admitidas para compartir. Las imágenes de placas y documentos permanecen privadas. La serie escrita y el contacto sólo aparecen si los autorizas expresamente. No se muestran notas internas ni campos vacíos.\n\n¿Puedo descargar un PDF? La ficha se consulta y comparte en la web. La descarga PDF está reservada al personal autorizado.\n\n¿Puedo regresar después? Sí. Los borradores guardados permanecen en tu panel. Si modificas una ficha compartida, vuelve a compartirla para actualizar el enlace.\n\n¿Enviar equivale a publicar? No. IMC México revisa la solicitud y autoriza por separado su publicación en el catálogo.'),
            'privacidad': ('Aviso de privacidad · pendiente de validación', 'Documento de trabajo pendiente de validación jurídica y de identificación formal del responsable por IMC México. Esta plataforma utiliza los datos de cuenta y contacto para gestionar acceso, borradores, solicitudes y atención. Las fotografías se conservan privadas salvo autorización expresa de difusión. Al pulsar Generar ficha de maquinaria, autorizas enviar las imágenes seleccionadas y los identificadores disponibles a OpenAI para preparar la ficha. Puedes escribir la serie sin fotografiar la placa o continuar sólo con fotos. La serie, la marca y el modelo aportados o identificados, y el tipo de equipo cuando no haya identificadores fiables, se utilizan en búsquedas web de referencias técnicas; las consultas no incluyen tu contacto ni la ubicación del equipo. Las series se comparten con el servicio de búsqueda para esta finalidad. Al habilitar Compartir ficha, autorizas una ficha web accesible a quienes tengan el enlace, con los datos completados y las fotografías de maquinaria admitidas para compartir. Puedes desactivar ese enlace. La serie escrita y el contacto permanecen privados salvo autorización expresa e independiente al compartir. Las imágenes de placas y documentos y las notas internas permanecen privadas. Compartir la ficha no autoriza su publicación en el catálogo de IMC México. La descarga PDF está reservada al personal autorizado. Puedes solicitar acceso, corrección, exportación o eliminación de tus datos desde Perfil y seguridad. Las finalidades comerciales adicionales requieren consentimiento independiente. IMC debe completar responsable, domicilio, contacto de privacidad, transferencias, plazos y procedimientos aplicables antes de habilitar el registro público.'),
            'terminos': ('Términos de uso · pendientes de validación', 'Documento de trabajo pendiente de validación jurídica por IMC México. El usuario declara contar con autorización para proporcionar información y fotografías de la maquinaria. Debe revisar y corregir los datos antes de enviar. Las sugerencias de IA y la revisión administrativa no certifican características, estado mecánico, propiedad ni documentación. Registrar una cuenta, obtener permiso de anunciante y aprobar una publicación son procesos distintos. Puedes habilitar y desactivar un enlace para compartir tu ficha preparada. Ese enlace no equivale a una publicación en el catálogo de IMC México. El envío a revisión no implica publicación automática ni garantiza una venta. No se incluyen pagos, subastas, financiamiento ni suscripciones. IMC debe validar las condiciones definitivas y el mecanismo de atención antes de habilitar el registro público.'),
        }
        ...
        for previous_defaults in (previous_research_defaults, previous_serial_defaults, previous_prepared_share_defaults):
            for key, (old_title, old_body) in previous_defaults.items():
