...
Cada consulta usa contexto `medium`, hasta dos acciones de herramienta con Luna/Terra (una con el perfil anterior) y el timeout del perfil de modelo (120 segundos con Luna/Terra; 65 en el perfil anterior). Esto permite buscar y abrir una referencia dentro de la misma etapa, sin aumentar la reserva global de investigación. Se reúnen hasta 36 fragmentos citados, 18.000 caracteres en total y 800 por fragmento; la normalización final compara la evidencia conjunta, por lo que un dato contradictorio se omite en lugar de ser reemplazado por el último resultado. No se adivinan países ni identificadores. Se reconocen etiquetas explícitas de fabricación en español, inglés, alemán, francés, italiano y portugués, conservando el país literal. «Serie HESSEN 016-9020» puede designar una familia comercial; «Número de serie OTRO123» continúa identificando otra unidad y se descarta.
