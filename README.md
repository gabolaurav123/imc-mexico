...
| IA | OpenAI Responses: `gpt-5.6-terra` para fotos y `gpt-5.6-luna` para investigación y texto; clave exclusiva de producción. [Configuración, consumo y migración](docs/model-upgrade.md) |
